...
namespace Library
{
    ...
    {
        string formLabel = "Íàèìåíîâàíèå ôîðìû";
        WinEnum? source;
        bool fromAddForm;
        List<int> rowSource = new List<int>();
        public List<string[]> returnRows;

        public main_form(string formLabelIn = "Âûäà÷à", WinEnum? sourceIn = WinEnum.Entries, bool fromAddForm = false)
        {
        ...
        public void displayAuthors()
        {
            using (Model.ApplicationContext db = new Model.ApplicationContext())
            {
                ...
                dataView.Columns[1].HeaderText = "Ôàìèëèÿ";
                dataView.Columns[2].HeaderText = "Èìÿ";
                dataView.Columns[3].HeaderText = "Îò÷åñòâî";
            }
        }
        ...
        public void displayPublishers()
        {
            using (Model.ApplicationContext db = new Model.ApplicationContext())
            {
                ...
                dataView.DataSource = items;
                //dataView.Columns[0].Visible = false;
                dataView.Columns[1].HeaderText = "Íàèìåíîâàíèå";
                dataView.Columns[2].HeaderText = "Àäðåñ";
            }
        }
        ...
        public void displayLibrarians()
        {
            using (Model.ApplicationContext db = new Model.ApplicationContext())
            {
                try
                {
                    ...
                    dataView.DataSource = items;
                    //dataView.Columns[0].Visible = false;
                    dataView.Columns[1].HeaderText = "Äîëæíîñòü";
                    dataView.Columns[2].HeaderText = "Ôàìèëèÿ";
                    dataView.Columns[3].HeaderText = "Èìÿ";
                    dataView.Columns[4].HeaderText = "Îò÷åñòâî";
                }
                catch { }
        ...
        public void displayBooks()
        {
            using (Model.ApplicationContext db = new Model.ApplicationContext())
            {
                try
                {
                    ...
                    dataView.DataSource = items;
                    //dataView.Columns[0].Visible = false;
                    dataView.Columns[1].HeaderText = "Íàçâàíèå";
                    dataView.Columns[2].HeaderText = "Äàòà ïóáëèêàöèè";
                    dataView.Columns[3].HeaderText = "Èçäàòåëüñòâî";
                    dataView.Columns[4].HeaderText = "Àâòîðû";
                    dataView.Columns[5].HeaderText = "Æàíðû";
                }
                catch { }
        ...
        private void âûäà÷àToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ðàáîòíèêèToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Functions.OpenNewWin(sender, WinEnum.Librarians);
        }

        private void äîëæíîñòèToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Functions.OpenNewWin(sender, WinEnum.Positions);
        }

        private void èçäàòåëüñòâàToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Functions.OpenNewWin(sender, WinEnum.Publishers);
        }

        private void æàíðûToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            switch (source)
            {
                ...
                case WinEnum.Books:
                    ...
                    using (Model.ApplicationContext db = new Model.ApplicationContext())
                    {
                        ...
                        //BookAuthorsView.Columns[1].HeaderText = "Ôàìèëèÿ";
                        //BookAuthorsView.Columns[2].HeaderText = "Èìÿ";
                        //BookAuthorsView.Columns[3].HeaderText = "Îò÷åñòâî";
                    }
                    break;
                case WinEnum.Users:
        ...
        private void BookGenreAdd_Click(object sender, EventArgs e)
        {
            ...
            BookGenresView.Columns[1].HeaderText = "Íàèìåíîâàíèå";
